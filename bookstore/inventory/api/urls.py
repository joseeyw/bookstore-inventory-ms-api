...
urlpatterns = [
    ...
    path('stock/history/',  views.StockHistoryListView.as_view(),  name = 'stock_list'),
    path('stock/history/<pk>/', views.StockHistoryDetailView.as_view(), name = 'stock_history_detail'),
